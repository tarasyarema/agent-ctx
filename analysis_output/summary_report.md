...
7. **`simple-summarization`** (claude-sonnet-4.5): 🔴 +176.2% (degrading)  
8. **`intent`** (gpt-4.1-mini): 🔴 +765.9% (degrading)  
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `avg_revenue_per_trip` | 0% | 100% | 33% | 50% | 20% | 0% | 33% | 0% | 33% | 0% | 0% | 0% |
| `best_revenue_hour` | 80% | 100% | 33% | 100% | 100% | 100% | 67% | 0% | 100% | 100% | 100% | 50% |
| `best_revenue_zone` | 80% | 100% | 100% | 75% | 100% | 100% | 67% | 100% | 100% | 100% | 100% | 100% |
| `optimal_distance_bracket` | 100% | 0% | 0% | 50% | 60% | 0% | 33% | 100% | 33% | 0% | 100% | 0% |
| `trips_above_max_distance` | 100% | 100% | 33% | 50% | 100% | 100% | 33% | 0% | 100% | 100% | 0% | 0% |
| `trips_below_min_fare` | 80% | 100% | 33% | 50% | 100% | 100% | 33% | 0% | 100% | 100% | 0% | 0% |
...
| Field | intent (claude-sonnet-4.5) | intent (google-gemini-2.5-pro) | intent (gpt-4.1) | intent (gpt-4.1-mini) | simple-raw (claude-sonnet-4.5) | simple-raw (google-gemini-2.5-pro) | simple-raw (gpt-4.1) | simple-raw (gpt-4.1-mini) | simple-summarization (claude-sonnet-4.5) | simple-summarization (google-gemini-2.5-pro) | simple-summarization (gpt-4.1) | simple-summarization (gpt-4.1-mini) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `avg_revenue_per_trip` | 40.8% | 0.0% | 4.4% | 4.0% | 35.0% | 39.7% | 17.2% | 8.0% | 29.2% | 43.7% | 8.0% | 35.1% |
| `best_revenue_hour` | 1.2% | 0.0% | 3.9% | 0.0% | 0.0% | 0.0% | 2.0% | 5.9% | 0.0% | 0.0% | 0.0% | 2.9% |
| `trips_above_max_distance` | 0.0% | 0.0% | 58.4% | 46.4% | 0.0% | 0.0% | 35.9% | 92.7% | 0.0% | 0.0% | 92.7% | 84.0% |
| `trips_below_min_fare` | 11.1% | 0.0% | 58.3% | 46.6% | 0.0% | 0.0% | 63.2% | 93.2% | 0.0% | 0.0% | 93.2% | 90.6% |
...
- **Average Cost:** $0.24
- **Average Time:** 181.9s
- **Average Tokens:** 132426
- **Tokens per Step:** 7394
- **Cost per Step:** $0.0132
- **Time per Step:** 10.14s
...
- **Average Cost:** $0.56
- **Average Time:** 525.8s
- **Average Tokens:** 208380
- **Tokens per Step:** 3946
- **Cost per Step:** $0.0114
- **Time per Step:** 11.47s
...
![Runs](https://img.shields.io/badge/runs-13-blue) ![Success](https://img.shields.io/badge/success-7-green) ![Failed](https://img.shields.io/badge/failed-6-red)
...
12. **`simple-raw`** (claude-sonnet-4.5): $0.85  
...
7. **`simple-summarization`** (gpt-4.1-mini): 129.1s  
8. **`simple-summarization`** (claude-sonnet-4.5): 165.6s  
9. **`intent`** (google-gemini-2.5-pro): 196.7s  
10. **`intent`** (claude-sonnet-4.5): 208.7s  
11. **`intent`** (gpt-4.1): 230.2s  
12. **`simple-raw`** (claude-sonnet-4.5): 945.9s  
...
*Report generated on 2025-11-07 18:03:08*
